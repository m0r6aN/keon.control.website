...
*Daily progress format: MASTER_PLAN.md - Section H.2*
'@
$epicB = New-GhIssue "[EPIC] WS-B - Spine Invariants" $bodyB "epic,caes-prep" "W3-W5"
...
*Daily progress format: MASTER_PLAN.md - Section H.2*
'@
$epicC = New-GhIssue "[EPIC] WS-C - Trust Roots and Cryptographic Infrastructure" $bodyC "epic,caes-prep" "W6-W7"
...
*Daily progress format: MASTER_PLAN.md - Section H.2*
'@
$epicD = New-GhIssue "[EPIC] WS-D - Evidence Pack Schema Extension" $bodyD "epic,caes-prep" "W8-W10"
...
*Daily progress format: MASTER_PLAN.md - Section H.2*
'@
$epicE = New-GhIssue "[EPIC] WS-E - CLI Validator" $bodyE "epic,caes-prep" "W8-W10"

$bodyF = @'
## WS-F: Chaos and Fail-Closed Testing
...
*Daily progress format: MASTER_PLAN.md - Section H.2*
'@
$epicF = New-GhIssue "[EPIC] WS-F - Chaos and Fail-Closed Testing" $bodyF "epic,caes-prep" "W6-W7"
...
*Daily progress format: MASTER_PLAN.md - Section H.2*
'@
$epicG = New-GhIssue "[EPIC] WS-G - DX / Python SDK / MCP" $bodyG "epic,caes-prep" "W8-W10"
...
*Daily progress format: MASTER_PLAN.md - Section H.2*
'@
$epicH = New-GhIssue "[EPIC] WS-H - Human Authority Delegation Model" $bodyH "epic,caes-prep" "W6-W7"
...
**Progress: __% to exit criteria** (update Mon + Thu)
"@
New-GhIssue "[CHECKLIST] WS-A - Deterministic Canonicalization" $ckA "checklist,caes-prep" "W3-W5"
...
**Progress: __% to exit criteria** (update Mon + Thu)
"@
New-GhIssue "[CHECKLIST] WS-B - Spine Invariants" $ckB "checklist,caes-prep" "W3-W5"
...
**Progress: __% to exit criteria** (update Mon + Thu)
"@
New-GhIssue "[CHECKLIST] WS-C - Trust Roots and Cryptographic Infrastructure" $ckC "checklist,caes-prep" "W6-W7"
...
**Progress: __% to exit criteria** (update Mon + Thu)
"@
New-GhIssue "[CHECKLIST] WS-D - Evidence Pack Schema Extension" $ckD "checklist,caes-prep" "W8-W10"
...
**Progress: __% to exit criteria** (update Mon + Thu)
"@
New-GhIssue "[CHECKLIST] WS-E - CLI Validator" $ckE "checklist,caes-prep" "W8-W10"
...
**Progress: __% to exit criteria** (update Mon + Thu)
"@
New-GhIssue "[CHECKLIST] WS-F - Chaos and Fail-Closed Testing" $ckF "checklist,caes-prep" "W6-W7"
...
**Progress: __% to exit criteria** (update Mon + Thu)
"@
New-GhIssue "[CHECKLIST] WS-G - DX / Python SDK / MCP" $ckG "checklist,caes-prep" "W8-W10"
...
**Progress: __% to exit criteria** (update Mon + Thu)
"@
New-GhIssue "[CHECKLIST] WS-H - Human Authority Delegation Model" $ckH "checklist,caes-prep" "W6-W7"
